...
NEBULA is developed by `Enrique Tomás Martínez Beltrán <https://www.enriquetomasmb.com/>`_ in collaboration with the `University of Murcia <https://www.um.es/en>`_, `Armasuisse <https://www.armasuisse.ch/en>`_, and the `University of Zurich (UZH) <https://www.uzh.ch/>`_.
