...
from nebula.core.optimizations.communications.KD.models.mnist.TeacherCNN import MDTeacherMNISTModelCNN, TeacherMNISTModelCNN
...
class StudentMNISTModelCNN(StudentNebulaModelV2):
    def __init__(
        self,
        input_channels=1,
        num_classes=10,
        ...
        if teacher_model is None:
            if mutual_distilation is not None and mutual_distilation == "MD":
                teacher_model = MDTeacherMNISTModelCNN(beta=teacher_beta)
            elif mutual_distilation is not None and mutual_distilation == "KD":
                teacher_model = TeacherMNISTModelCNN()
