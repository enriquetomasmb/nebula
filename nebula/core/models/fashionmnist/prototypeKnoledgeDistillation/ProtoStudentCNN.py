...
from nebula.core.models.fashionmnist.prototypeKnoledgeDistillation.ProtoTeacherCNN import \
...
class ProtoStudentFashionMNISTModelCNN(ProtoStudentFedstellarModel):
    """
