...
from nebula.core.models.prototypeKnoledgeDistillationBaseNebulaModel.prototeacherfedstellarmodel import ProtoTeacherFedstellarModel
...
class ProtoTeacherResNet(ProtoTeacherFedstellarModel, ABC):
    ...
    def __init__(
        ...
        self.fc_dense = nn.Linear(num_filters[3] * block.expansion, num_filters[3] * block.expansion // 2)
        self.fc = nn.Linear(num_filters[3] * block.expansion // 2, num_classes)
