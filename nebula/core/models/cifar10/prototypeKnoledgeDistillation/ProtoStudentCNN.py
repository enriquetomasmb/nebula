...
from nebula.core.models.cifar10.prototypeKnoledgeDistillation.ProtoTeacherCNN import ProtoTeacherCIFAR10ModelCNN, \
    MDProtoTeacherCIFAR10ModelCNN
from nebula.core.models.prototypeKnoledgeDistillationBaseNebulaModel.protostudentfedstellarmodel import ProtoStudentFedstellarModel


class ProtoStudentCIFAR10ModelCNN(ProtoStudentFedstellarModel):
    """
