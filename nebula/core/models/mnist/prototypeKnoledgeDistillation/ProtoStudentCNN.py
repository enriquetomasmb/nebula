...
from nebula.core.models.mnist.prototypeKnoledgeDistillation.ProtoTeacherCNN import \
    MDProtoTeacherMNISTModelCNN, ProtoTeacherMNISTModelCNN
...
class ProtoStudentMNISTModelCNN(ProtoStudentFedstellarModel):
    """
