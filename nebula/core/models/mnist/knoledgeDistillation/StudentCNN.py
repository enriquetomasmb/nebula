...
from nebula.core.models.mnist.knoledgeDistillation.TeacherCNN  import MDTeacherMNISTModelCNN, \
    TeacherMNISTModelCNN

from nebula.core.models.knoledgeDistillationBaseNebulaModel.studentfedstellarmodelV2 import StudentFedstellarModelV2

class StudentMNISTModelCNN(StudentFedstellarModelV2):
    def __init__(
            self,
            input_channels=1,
            num_classes=10,
