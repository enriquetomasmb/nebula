...
from nebula.core.research.FedProto.models.mnist.FedProtoCNN import ProtoMNISTModelCNN


def test_initialization():
    """Test initialization of ProtoMNISTModelCNN"""
