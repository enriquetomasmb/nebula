...
from nebula.core.optimizations.communications.KD_prototypes.models.cifar100.ProtoTeacherResnet32 import MDProtoTeacherCIFAR100ModelResNet32
...
def test_initialization_md_proto_teacher_cifar100():
    model = MDProtoTeacherCIFAR100ModelResNet32(input_channels=16, num_classes=100)
...
def test_forward_pass_md_proto_teacher_cifar100():
    model = MDProtoTeacherCIFAR100ModelResNet32(input_channels=16, num_classes=100)
...
def test_loss_and_optimizers_md_proto_teacher_cifar100():
    model = MDProtoTeacherCIFAR100ModelResNet32(input_channels=16, num_classes=100)
    optimizer = model.configure_optimizers()
    assert isinstance(optimizer, torch.optim.Adam), "Optimizer should be an instance of Adam"


def test_prototype_integration_md_proto_teacher_cifar100():
    model = MDProtoTeacherCIFAR100ModelResNet32(input_channels=16, num_classes=100)
    model.set_student_model(ProtoStudentCIFAR100ModelResnet18())
...
def test_loss_combination_proto_teacher_md_cifar100():
    model = MDProtoTeacherCIFAR100ModelResNet32(input_channels=3, num_classes=100)
    model.set_student_model(ProtoStudentCIFAR100ModelResnet18())
