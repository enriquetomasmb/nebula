...
def test_initialization_proto_student_cifar100():
    model = ProtoStudentCIFAR100ModelResnet18(input_channels=3, num_classes=100)
    assert model.input_channels == 3, "Input channels should be 3"
...
def test_forward_pass_proto_student_cifar100():
    model = ProtoStudentCIFAR100ModelResnet18(input_channels=3, num_classes=100)
...
def test_optimizer_configuration_proto_student_cifar100():
    model = ProtoStudentCIFAR100ModelResnet18(input_channels=3, num_classes=100)
...
def test_prototype_integration_proto_student_cifar100():
    model = ProtoStudentCIFAR100ModelResnet18(input_channels=3, num_classes=100)
...
def test_loss_combination_proto_student_cifar100():
    model = ProtoStudentCIFAR100ModelResnet18(input_channels=3, num_classes=100)
